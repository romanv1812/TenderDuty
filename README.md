...
#### Необходимо ввести полученный URL в config.yaml
```bash
nano $HOME/tenderduty/config.yml # Или открыть через SFTP config.yml
```
<img width="475" alt="image" src="https://user-images.githubusercontent.com/83868103/190871914-0f5b211c-873e-4adb-9683-b8630c6b1965.png">

#### После замены выполняем рестарт командой:

```bash
docker restart tenderduty
```
#### Результат:  
<img width="385" alt="image" src="https://user-images.githubusercontent.com/83868103/190872014-f52536da-f351-4bdc-bef8-8d3afcea70aa.png">
